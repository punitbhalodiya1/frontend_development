...
$(document).ready(function(){
    ...
    $('#google-sheet').on("submit",function(){
        ...
        if(validateForm()){
            $.ajax({
                 type : "POST",
                 url : "https://script.google.com/macros/s/AKfycbwXysu16xrUm8sQIN0ADI3-AkS8sdpkAm7cCPi9Oorqb72k9N9QUdsoV216iF7_C2_WNg/exec",
                 data : $this.serialize(),
                 success: function(response) {
                        ...
                        setTimeout(function() {
                            window.location.href = "https://gupshupcommunica8.com/tr/thankyou.html";    
                        }, 2000);
                    },
