...
$(document).ready(function(){
    ...
    $('#google-sheet').on("submit",function(){
        ...
        if(validateForm()){
            $.ajax({
                 type : "POST",
                 url : "https://script.google.com/macros/s/AKfycbyhnG3_0ddyODUMDFJ90PRmX1dkY4bqe9UM5o7S-G-5Vajk6Pt5sf5s3kMbt1AadkgZcQ/exec",
                 data : $this.serialize(),
                 success: function(response) {
                        ...
                        // setTimeout(function() {
                        //     window.location.href = "https://gupshupcommunica8.com/meetup_landing_page/thankyou-argentina.php";    
                        // }, 2000);
    ...
    $('#google-sheet-top').on("submit",function(){
        ...
        if(validateFormTop()){
            $.ajax({
                 ...
                 data : $this.serialize(),
                 success: function(response) {
                        $('#refinal_msg').html("Gracias por contactarnos..! Nos pondremos en contacto con usted pronto..").addClass('success').removeClass('error'); 
