                    ...
                    <tr>
                        <td>
                            <a target="_blank" href="https://www.gupshup.io/">
                                <img src="http://54.163.12.14/portfolio/email_templates/meetup/singapore/images/thankyou-banner.png" width="600" alt="" style="width:100%;height:auto;max-width:100%;display:block;">
                            </a>
                        </td>
                    </tr>
                                        ...
                                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="padding-bottom: 15px;">
                                                    <p style="font-size:13px;line-height:1.333;font-weight:400;font-family: \'Poppins\', sans-serif;color:#000000;margin:0;padding:0;">Hi</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding-bottom: 15px;">
                                                    <p style="font-size:13px;line-height:1.333;font-weight:400;font-family: \'Poppins\', sans-serif;color:#000000;margin:0;padding:0;">Thank you for registering for this event! We are excited to have you join us for a day of learning and networking. This event will provide insights into the latest trends in conversational commerce and how businesses are using chatbots and other tools to improve customer engagement.</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding-bottom: 15px;">
                                                    <p style="font-size:13px;line-height:1.333;font-weight:400;font-family: \'Poppins\', sans-serif;color:#000000;margin:0;padding:0;">You can also leverage the power of WhatsApp, Instagram & GBM amongst others for your business.</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding-bottom: 15px;">
                                                    <p style="font-size:13px;line-height:1.333;font-weight:700;font-family: \'Poppins\', sans-serif;color:#000000;margin:0;padding:0;">We hope you leave this event with a better understanding of how to use conversational commerce to benefit your business.</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding-bottom: 15px;">
                                                    <p style="font-size:13px;line-height:1.333;font-weight:400;font-family: \'Poppins\', sans-serif;color:#000000;margin:0;padding:0;">Thanks again for registering, and we look forward to seeing you at the event!</p>
                                                </td>
                                            </tr> 
                                            <tr>
                                                <td style="padding-bottom: 15px;">
                                                    <p style="font-size:13px;line-height:1.333;font-weight:400;font-family: \'Poppins\', sans-serif;color:#000000;margin:0;padding:0;"><span style="font-weight: 700;">Venue:</span> Qanvast @ OUE, Singapore</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding-bottom: 25px;">
                                                    <p style="font-size:13px;line-height:1.333;font-weight:400;font-family: \'Poppins\', sans-serif;color:#000000;margin:0;padding:0;"><span style="font-weight: 700;">Date & Time:</span> 1st Nov 2022. 15:00 Onwards</p>
                                                </td>
                                            </tr>                                                                           
                                            <tr>
                                                <td style="padding-bottom: 25px;">
                                                    <p style="font-size:13px;line-height:1.333;font-weight:500;font-family: \'Poppins\', sans-serif;color:#000000;margin:0;padding:0;">Thanks,<br><strong style="font-weight: 700;">Team Gupshup</strong></p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding-bottom: 0;">
                                                    <a target="_blank" href="https://www.gupshup.io/">
                                                        <img src="http://54.163.12.14/portfolio/email_templates/meetup/singapore/images/logo-footer.png" width="113" alt="logo-footer.png" style="height:auto;max-width:100%;display:inline-block;">
                                                    </a>
                                                </td>
                                            </tr>
                                        </table>
