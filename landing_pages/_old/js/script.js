...
jQuery(window).on('load', function() { 
    jQuery.ready.then(function() {
        ...
        jQuery(".forth-click, .fifth-click").click(function() {
            var targetDiv = jQuery('.first-section');
            //jQuery('.ts-sidebar-content ul li').removeClass('active');
            //jQuery(this).parent().addClass('active');
            jQuery('html, body').animate({
...
$(document).ready(function(){
    ...
    $('#google-sheet').on("submit",function(){
        ...
        if(validateForm()){
            $.ajax({
                 type : "POST",
                 url : "https://script.google.com/macros/s/AKfycbwGb27ZV0PL_tflHgB9QqKVSYQnA6wsuYjGeQZt2wuk0ZaKUE5KB6-059alaYCZQzmNcg/exec",
                 data : $this.serialize(),
